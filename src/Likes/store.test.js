...
test('should add like to likes array when given a likes/locationSelected action', () => {
    const currentState = {
        likes: [],
        isLoading: false
    }
...
test('should change isLoading state to false when given a likes/locationSelected action', () => {
    const currentState = {
        likes: [],
        isLoading: true
    }
